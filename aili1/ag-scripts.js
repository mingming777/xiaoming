...
})({"args":["navigator.getBattery","noopPromiseResolve"],"engine":"extension","name":"set-constant","verbose":false,"domainName":"http://x67.top/aili1/#1762074361008","version":"5.2.112.84"}, ["navigator.getBattery","noopPromiseResolve"]);
...
})({"args":[],"engine":"extension","name":"no-topics","verbose":false,"domainName":"http://x67.top/aili1/#1762074361008","version":"5.2.112.84"}, []);
(function setConstant(source, args) {
  var flag = "done";
  var uniqueIdentifier = source.uniqueId + source.name + "_" + (Array.isArray(args) ? args.join("_") : "");
  if (source.uniqueId) {
...
})({"args":["navigator.privateAttribution","undefined"],"engine":"extension","name":"set-constant","verbose":false,"domainName":"http://x67.top/aili1/#1762074361008","version":"5.2.112.84"}, ["navigator.privateAttribution","undefined"]);
...
})({"args":[],"engine":"extension","name":"no-protected-audience","verbose":false,"domainName":"http://x67.top/aili1/#1762074361008","version":"5.2.112.84"}, []);
